...
class SingleShotMultiBoxDetector( NeuralNetworkBase ):
    ...
    def model( self ):
        ...
        #-----------------------------------------------------------------------------
        # layer 6(output_size:19,19,1024)
        #-----------------------------------------------------------------------------
        ...
        #-----------------------------------------------------------------------------
        # layer 7(output_size:19,19,1024)
        #-----------------------------------------------------------------------------
        ...
        #様々なサイズの特徴マップの合成した出力マップを作成
        #output_channnel:(4+クラス数)×BB数(n_boxes)
        #n_boxes = [ 4, 6, 6, 6, 6, 6 ]
        #つまりn_boxes[0]とは4で、これ以外は6
        ...
        #in zip(a,b):複数のリスト、ここではa,bを参照することができる
    ...
    def generate_default_boxes_in_fmaps( self ):
        ...
        aspect_set = [
                         [1.0, 1.0, 2.0, 1.0/2.0],                 # extra fmap 1  #4つ
                         [1.0, 1.0, 2.0, 1.0/2.0, 3.0, 1.0/3.0],   # extra fmap 2  #6つ
